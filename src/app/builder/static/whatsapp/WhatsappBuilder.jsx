...
import { whatsAppBuilderFormSchewma } from "../../../../constants/validationSchema";
import { useGetSingleQRCode } from "../../../../hooks/useGetSingleQRCode";

const WhatsappBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(whatsAppBuilderFormSchewma),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticWhatsAppContent || {};
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-full">
                <LeftAccordion title="Whatsapp Information">
                  <TextInfo
