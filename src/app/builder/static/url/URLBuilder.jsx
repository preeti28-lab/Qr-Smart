...
import { urlBuilderFormSchema } from "../../../../constants/validationSchema";
import { useGetSingleQRCode } from "../../../../hooks/useGetSingleQRCode";

const URLBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(urlBuilderFormSchema),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticURLContent || {};
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-full">
                <LeftAccordion title="Website Information">
                  <OfferInfo
