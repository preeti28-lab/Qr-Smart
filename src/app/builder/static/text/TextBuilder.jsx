...
const TextBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(textBuilderFormSchema),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticTextContent || {};
