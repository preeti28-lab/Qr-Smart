...
import TextInfo from "./EmailInfo";
...
const EmailBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    // resolver: yupResolver(emailBuilderFormSchema),
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticEmailContent || {};
...
setIsCenterStyle(styling?.isCenterStyle ?? null);
  ...
  const handleFinishClick = () => {
    ...
    Object.keys(payload).forEach((key) => {
      if (key !== "profileImg" && key !== "pdf" && key !== "pdfs") {
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-full">
                <LeftAccordion title="Email Information">
                  <TextInfo
