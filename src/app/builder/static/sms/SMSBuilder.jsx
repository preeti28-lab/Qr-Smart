...
import { smsBuilderFormSchewma } from "../../../../constants/validationSchema";
import { useGetSingleQRCode } from "../../../../hooks/useGetSingleQRCode";

const SMSBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(smsBuilderFormSchewma),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticSMSContent || {};
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-full">
                <LeftAccordion title="SMS Information">
                  <TextInfo
