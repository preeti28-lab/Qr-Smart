...
import { wifiBuilderFormSchewma } from "../../../../constants/validationSchema";
import { useGetSingleQRCode } from "../../../../hooks/useGetSingleQRCode";

const WifiBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(wifiBuilderFormSchewma),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticWifiContent || {};
...
setIsCenterStyle(styling?.isCenterStyle ?? null);
    ...
    const formattedFormData = {
      encryptionType: eventContent?.encryptionType || "",
      hiddenNetwork: eventContent?.hiddenNetwork || "",
      networkName: eventContent?.networkName || "",
      networkPassword: eventContent?.networkPassword || "",
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <div className="w-full">
                <LeftAccordion title="WiFi Information">
                  <TextInfo
