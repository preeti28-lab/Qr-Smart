...
import OfferInfo from "./TextInfo";
...
import { normalVCardBuilderFormSchewma } from "../../../../constants/validationSchema";
import { useGetSingleQRCode } from "../../../../hooks/useGetSingleQRCode";

const NormalVCardBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(normalVCardBuilderFormSchewma),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.staticVcardContent || {};
...
setIsCenterStyle(styling?.isCenterStyle ?? null);
    ...
    const formattedFormData = {
      ...
      fullName: eventContent?.fullName || "",

      message: eventContent?.message || "",
      note: eventContent?.note || "",
      organization: eventContent?.organization || "",

      phone: eventContent?.phone || "",
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                <div className="w-full">
                  <LeftAccordion title="VCard Details">
                    <OfferInfo
...
export default NormalVCardBuilder;
