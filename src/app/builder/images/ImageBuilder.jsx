...
import { imageBuilderFormSchema } from "../../../constants/validationSchema";
...
const ImageBuilder = ({ currentFormData, setCurrentFormData }) => {
  ...
  const methods = useForm({
    ...
    resolver: yupResolver(imageBuilderFormSchema),
  });
  ...
  useEffect(() => {
    ...
    const eventContent = qrData?.imageContent || {};
