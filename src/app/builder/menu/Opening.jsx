...
const Opening = ({ currentFormData, iconColor, iconBgColor  , outer}) => {
  ...
  return (
    <div className={`bg-white rounded-md p-2 space-y-4  ${outer === true ? 'px-3' : 'px-0' } `}>
      <div className="border p-2">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-semibold text-xs">Opening Hours</span>
        </div>
